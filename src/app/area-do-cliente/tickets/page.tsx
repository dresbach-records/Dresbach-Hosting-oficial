        ...
        <div className="space-y-4">
            ...
            <Card>
                ...
                <CardContent className="text-center py-16 text-muted-foreground">
                    ...
                    <p>Se precisar de ajuda, por favor <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold hover:underline">fale conosco no WhatsApp</a>.</p>
                </CardContent>
