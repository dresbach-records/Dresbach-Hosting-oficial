...
const MaintenanceBanner = () => (
    <div className="bg-yellow-400 text-yellow-900 p-3 text-center text-sm font-medium z-50 relative">
        <div className="container flex flex-col sm:flex-row items-center justify-center gap-2">
            ...
            <p>
                ...
                <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="font-bold underline hover:text-yellow-800 whitespace-nowrap">
